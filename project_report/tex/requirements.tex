...
since there is only so much randomness and correctness you can get out of a 
simulator. 
It is still very important to have the simulator, when making prototypes and 
performing multiple tests on it, so the group doesn't push any regressions to 
