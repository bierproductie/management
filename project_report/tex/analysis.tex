...
Operation contracts is used to specify what state the program is in, before it 
can run the operation. Operation contracts also specify what happens after the
operation is run.
\begin{table}[H]
