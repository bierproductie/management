...
production speed for the machine. \cite{ops}
...
charts will be used. \cite{scrum}
...
determine new tasks for next sprint.
...
issues are created in ZenHub and assigned a sprint and storypoints. The KanBan
