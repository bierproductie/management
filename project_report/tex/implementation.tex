...
% TODO: add text about the table below
...
\begin{table}[ht]
     ...
     \hline
     \textbf{Product type} & \textbf{Normalised Machine Speed} & \textbf{Optimal Production Speed}\\
     \hline
     Pilsner & 72,61\% of 600 & 435,63 products/min \\
     \hline
     Wheat & 51,58\% of 300 & 154,75 products/min \\
     \hline
     IPA & 62,55\% of 150 & 93,83 products/min \\
     \hline
     Stout & The equation has no solution in ${\rm I\!R}$ for \(x\) & 200 products/min (max) \\
     \hline
     Ale & 91,82\% of 100 & 91,82 products/min \\
     \hline
     Alcohol Free & 76,35\% of 125 & 95,44 products/min \\
     \hline
    \end{tabularx}
...
% TODO: write about stout -> optimal speed is max speed - refer to graph in appendix
