...
% Functions where x=normalised machinespeed and y=oee
% Pilsner:\\
% \[y = -0,0003x^3 + 0,0291x^2 - 0,95x + 107,38\]
% \[R^2 = 0,9916\]

% Wheat:\\
% \[y = -5E-05x^3 + 0,0077x^2 - 1,3163x + 103,63\]
% \[R^2 = 0,9983\]

% IPA:\\
% \[y = 0,0001x^3 - 0,0548x^2 + 3,7529x + 28\]
% \[R^2 = 0,9981\]

% Stout:\\
% \[y = 0,0002x^3 - 0,0319x^2 + 1,551x + 32,929\]
% \[R^2 = 0,9331\]

% Ale:\\
% \[y = 2E-05x^3 - 0,0099x^2 + 0,5615x + 90,814\]
% \[R^2 = 1\]

% Alcohol free:\\
% \[y = -3E-05x^3 + 0,0021x^2 - 0,4464x + 90\]
% \[R^2 = 0,9935\]
