...
When a batch is complete, the calculation of the OEE takes place, which the data
stored in the batch class is used for.\\
...
been decided to only use the time it takes to produce a batch. The calculation
can be seen below.
