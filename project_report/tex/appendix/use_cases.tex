...
% stop production
\begin{table}[ht]
    \captionof{table}{Production Control: Stop production} 
...
% abort
\begin{table}[ht]
    \captionof{table}{Production Control: Abort the current production} 
    \begin{tabularx}{\textwidth}{|>{\RaggedRight}X|}
        \hline
        \textbf{ID:} UC03  \\
        \hline
...
% reset
\begin{table}[ht]
    \captionof{table}{Production control: Reset the machine}
    \begin{tabularx}{\textwidth}{|>{\RaggedRight}X|}
        \hline
        \textbf{ID:} UC04  \\
        \hline
...
% clear
\begin{table}[ht]
    \captionof{table}{Production control: Clear the machine}
    \begin{tabularx}{\textwidth}{|>{\RaggedRight}X|}
        \hline
        \textbf{ID:} UC05  \\
        \hline
...
% display live data
\begin{table}[ht]
    \captionof{table}{Production monitoring: Display live data}
    \begin{tabularx}{\textwidth}{|>{\RaggedRight}X|}
        \hline
        \textbf{ID:} UC06  \\
        \hline
...
\begin{table}[ht]
    \captionof{table}{Batch report: Generate batch report}
    \begin{tabularx}{\textwidth}{|>{\RaggedRight}X|}
        \hline
        \textbf{ID:} UC07  \\
        \hline
