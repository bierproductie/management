...
\begin{table}[ht]
    \captionof{table}{Batch Data: Pilsner}
...
\begin{table}[ht]
    \captionof{table}{Batch Data: Wheat}
     \begin{tabularx}{\textwidth}{|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|}
     \hline
...
\begin{table}[ht]
    \captionof{table}{Batch Data: IPA}
     \begin{tabularx}{\textwidth}{|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|}
     \hline
...
\begin{table}[ht]
    \captionof{table}{Batch Data: Stout}
     \begin{tabularx}{\textwidth}{|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|}
     \hline
...
\begin{table}[ht]
    \captionof{table}{Batch Data: Ale}
     \begin{tabularx}{\textwidth}{|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|}
     \hline
...
\begin{table}[ht]
    \captionof{table}{Batch Data: Alcohol Free}
     \begin{tabularx}{\textwidth}{|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|>{\RaggedRight}X|}
     \hline
