...
\ifnum \value{PROD}=1
    \includegraphics[scale=0.07]{signatures/signatureJR.jpg}
    \vspace{-9.5mm}
\fi
...
\ifnum \value{PROD}=1
    \includegraphics[scale=0.3]{signatures/signature_kechr19.PNG}
    \vspace{-5mm}
\fi
\par\rule{\textwidth}{0.4pt}
...
\ifnum \value{PROD}=1
    \includegraphics[scale=0.3]{signatures/signature_kepet19.png}
    \vspace{-8mm}
\fi
\par\rule{\textwidth}{0.4pt}
...
\ifnum \value{PROD}=1
    \includegraphics[scale=0.04]{signatures/signature_kjako19.jpg}
    \vspace{-9.5mm}
\fi
\par\rule{\textwidth}{0.4pt}
...
\ifnum\value{PROD}=1
    \includegraphics[scale=0.042]{signatures/signatureSJ.png}
    \vspace{-3.5mm}
\fi
\par\rule{\textwidth}{0.4pt}
