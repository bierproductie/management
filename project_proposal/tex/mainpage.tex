...
value, time to market etc. Kenneth Munk Christiansen was chosen to be Scrum
...
built around git, a version control system that allows each teammember to
download the code, modify it and upload the new version. Each issue will have
its own branch that will be reviewed after it has been modified, before it's
merged with the main branch. This ensures that the quality of content is up to
standard.
