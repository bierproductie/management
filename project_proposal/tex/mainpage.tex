...
The stakeholders for this should be Reflevsbæk, but since project group don't 
have any communicate with them, which is a problem when developing using SCRUM.
Since Stakeholders role is usually filled by a Product Owner role 
(abbreviated to PO from here on out). The PO should under
