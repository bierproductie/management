...
\sout{The stakeholder for this project should be Reflevsbæk, but since we don't 
communicate with them, We have chosen our selfs to be the Stakeholders for 
this project. Normally the project would have a extern Project Owner, when 
working with SCRUM.
\newline

Normally Reflevsbæk should have been the stakeholder, but since we 
don't communicate with them, we have chosen ourself. }
...
The group do not actually have any stakeholder because they don't have any 
communication Reflevsbæk that normally would have been the stakeholder for the 
project. 
